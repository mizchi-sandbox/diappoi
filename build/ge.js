(function() {
  var Anim, Animation, AreaHit, Armor, Blade, Canvas, Character, CharacterObject, ClothArmor, Color, Dagger, DamageHit, EquipItem, FieldScene, Game, GameData, Goblin, HealObject, Item, ItemBox, ItemObject, Map, MenuScene, MoneyObject, Node, ObjectGroup, OpeningScene, Player, SampleMap, Scene, SingleHit, Skill, Skill_Atack, Skill_Heal, Skill_Meteor, Skill_Smash, Skill_ThrowBomb, SmallShield, Sprite, Status, Sys, TargetAreaHit, TresureObject, UseItem, Util, Weapon, base_block, include, maps, my, randint, rjoin, sjoin, _;
