(function() {
  var Battler, Enemy, FieldScene, Game, OpeningScene, Player, Scene, Sprite, Status, assert, keys, mouse, my, vows;
  ...
  vows.describe('Game Test').addBatch({
    'combat test': {
      ...
      'test': function() {
        ...
        return console.log(p.state.alive);
      },
      topic: "scene",
      'test2': function() {
        var scene;
